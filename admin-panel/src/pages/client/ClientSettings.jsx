    ...
    <ClientLayout title="Settings">
      ...
      {!loading && !loadError && (
        <form onSubmit={handleSubmit} className="mx-auto max-w-2xl space-y-6">
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <h2 className="mb-4 text-base font-semibold text-gray-900">Assistant</h2>
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <h2 className="mb-4 text-base font-semibold text-gray-900">Change Portal Password</h2>
            <div className="space-y-4">
              <div>
              ...
              <p className="text-xs text-gray-500">Leave blank to keep your current password. Must be at least 8 characters.</p>
            </div>
          </section>
